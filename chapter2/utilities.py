...
def SolveRKF45(f, y0, tSpan=np.array([0., 10.0]), tol=1.e-8):
...
def TwoBody3DRates(t, Y, m1=1., m2=.1):
...
def TwoBody3D(R1_0, V1_0, R2_0, V2_0, tSpan=np.array([0., 10.0]), m1=1., m2=1.):
    ...
    Rates = lambda t, Y: TwoBody3DRates(t, Y, m1, m2)
    
    ys, ts = SolveRKF45(Rates, Y0, tSpan)
